<%@ Page Title="SignIn" Language="C#" MasterPageFile="~/HomeLoan/UserMaster.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="HomeLoanApply.HomeLoan.WebForm7" %>
...
<center>
        <table style="width: 433px; height: 370px; background-color: #FF9933; font-size: large; font-weight: bold;">
            ...
            <tr>
                ...
                <td align="center"><asp:TextBox ID="txtUsername" runat="server" placeholder=" Username/Email ID"></asp:TextBox>
            ...
            <tr>
                <td colspan="2" align="center"><asp:Button ID="btnSignIn" runat="server" Text="Login" BackColor="#669900" Font-Bold="True" Font-Size="Large" ForeColor="White" OnClick="btnSignIn_Click"  ></asp:Button>
                    &nbsp&nbsp&nbsp<asp:LinkButton ID="LinkButtonRegistration" runat="server" ForeColor="#FFFFCC" OnClick="LinkButtonRegistration_Click" >Sign Up</asp:LinkButton>&nbsp&nbsp&nbsp
